    ...
    setFilterFn({
      fn: items => {
        if (target.value === "")
          ...
          return items
            .filter(x => x.curso.nombre.toLowerCase()
                ...
                {cursosCargados ? (
                  ...
                  <TblHead />
                    ...
                    <TableBody>
                    {
                        ...
                        <StyledTableRow key={item.curso.id}>
                            <StyledTableCell>{item.curso.codigo}</StyledTableCell>
                            <StyledTableCell>{item.curso.nombre}</StyledTableCell>
                            <StyledTableCell>{item.curso.seccion ? item.curso.seccion.departamento.nombre : ""}</StyledTableCell>
                            <StyledTableCell>{item.curso.seccion ? item.curso.seccion.nombre : ""}</StyledTableCell>  
                            <StyledTableCell align = "center">{item.curso.creditos}</StyledTableCell>
